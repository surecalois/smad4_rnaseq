...
prep_table = function(expr.table,check.complete = F){
  ...
  cat("I drop these genes from the table,weird stuff: --JX\n",paste(dropnames[1:k],collapse = '\n'),"...")
  genes = genes[!dc]
...
load_list = function(file){
  ...
  if(missing(file)) file = "/Users/jiexu/Desktop/templist.txt"
  ...
  if(file == 'CMD') file = "/Users/jiexu/genome/annotation/list/my_cardiacDiff.txt"
...
gene_map_v24 = "/Users/jiexu/genome/annotation/gencode/V24/gene_map_v24.txt"
ens2gencode_v24 = "/Users/jiexu/genome/annotation/gencode/V24/ens2gencode_v24.txt"

gene_map_v26 = "/Users/jiexu/genome/annotation/gencode/V26/gene_map_v26lift37.txt"
ens2gencode_v26 = "/Users/jiexu/genome/annotation/gencode/V26/ens2gencode_v26lift37.txt"
...
dir = "/Users/jiexu/Desktop/owncloud/kclab/expression_tables/core/"
